...
define dso_local void @foo() #0 !dbg !23 {
  ...
  %2 = call i8* @malloc(i64 8) #5, !dbg !30
...
define dso_local void @bar() #0 gc "statepoint-example" !dbg !34 {
  ...
  %7 = call i8* @malloc(i64 8) #5, !dbg !44
  ...
  %statepoint_token = call token (i64, i32, void ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_isVoidf(i64 2882400000, i32 0, void ()* @foo, i32 0, i32 0, i32 0, i32 0, i8* %7)
  %boxedVal = call i32*  @llvm.experimental.gc.relocate.p1i32(token %statepoint_token, i32 7, i32 7)
  %statepoint_token1 = call token (i64, i32, void (i64*, i32*)*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_isVoidp0i64p0i32f(i64 2882400000, i32 0, void (i64*, i32*)* @readStackMap, i32 2, i32 0, i64* bitcast (%struct.StackMap* @__LLVM_StackMaps to i64*), i32* getelementptr inbounds ([2 x i32], [2 x i32]* @loc, i64 0, i64 0), i32 0, i32 0), !dbg !48
...
define dso_local i32 @main() #0 gc "statepoint-example" !dbg !74 {
  ...
  %2 = call i8* @malloc(i64 8) #5, !dbg !79
  ...
  %statepoint_token = call token (i64, i32, void ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_isVoidf(i64 2882400000, i32 0, void ()* @bar, i32 0, i32 0, i32 0, i32 0, i8* %2), !dbg !83
  %boxedVal = call i32*  @llvm.experimental.gc.relocate.p1i32(token %statepoint_token, i32 7, i32 7)
  ret i32 0, !dbg !84
}
...
declare token @llvm.experimental.gc.statepoint.p0f_isVoidp0i64p0i32f(i64 immarg, i32 immarg, void (i64*, i32*)*, i32 immarg, i32 immarg, ...)
